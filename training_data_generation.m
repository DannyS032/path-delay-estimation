% Training data generation script - Path Delay Estimation Project
% Written by Danny Sinder
% Run this script to generate two training data files (per SNR case)
...
filename_low = append(save_folder,'/train_data_high.h5');
generate_training_data(num_samples, Fs, N, ...
    pilot_index, tau_rms, 'l', up_sample, filename_low);

% High SNR case training data generation
filename_high = append(save_folder,'/train_data_low.h5');
generate_training_data(num_samples, Fs, N, ...
